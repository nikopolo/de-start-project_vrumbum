...
create table if not exists car_shop.cars (
	id serial primary key,
	brand_car_id integer references car_shop.brand_cars(id), /*ссылка на id иммеющий тип integer*/
	...
	brand_origin_id integer references car_shop.origins_country(id), /*ссылка на id иммеющий тип integer*/
...
create table if not exists car_shop.clients_discount (
	...
	auto_id integer references car_shop.cars, /*ссылка на id иммеющий тип integer*/
	discount smallint /*скидка имеет небольшой диапазон чисел*/
);

create table if not exists car_shop.cars_colors (
	id serial primary key,
	color_id integer references car_shop.colors, /*ссылка на id иммеющий тип integer*/
	car_id integer references car_shop.cars /*ссылка на id иммеющий тип integer*/
);